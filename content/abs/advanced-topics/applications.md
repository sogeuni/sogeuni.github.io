...
Clever use of I/O redirection permits parsing and stitching together snippets of command output (see [[../commands/internal-commands-and-builtins#^READREDIR|Example 15-7]]). This permits generating report and log files.
